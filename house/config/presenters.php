...
return [
    ...
    */
	...
	house\Page::class => house\Presenters\PagePresenter::class,
	house\Post::class => house\Presenters\PostPresenter::class,
	house\User::class => house\Presenters\UserPresenter::class,
];
